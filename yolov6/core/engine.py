...
import utils.tools.eval as eval
...
class Trainer:
    ...
    def calibrate(self, cfg):
        ...
        if self.main_process:
            from utils.tools.qat.qat_utils import ptq_calibrate
    ...
    def quant_setup(self, model, cfg, device):
        if self.args.quant:
            from utils.tools.qat.qat_utils import qat_init_model_manu, skip_sensitive_layers
